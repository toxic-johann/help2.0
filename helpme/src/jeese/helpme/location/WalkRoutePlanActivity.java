...
public class WalkRoutePlanActivity extends Activity implements OnClickListener,
		AMapNaviListener {
	...
	private void startGPSNavi() {
		if (mIsCalculateRouteSuccess) {
			Intent gpsIntent = new Intent(WalkRoutePlanActivity.this, NaviActivity.class);
