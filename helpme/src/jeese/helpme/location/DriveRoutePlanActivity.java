...
public class DriveRoutePlanActivity extends Activity implements OnClickListener,
		AMapNaviListener {
	...
	private void startGPSNavi() {
		if (mIsCalculateRouteSuccess) {
			Intent gpsIntent = new Intent(DriveRoutePlanActivity.this, NaviActivity.class);
